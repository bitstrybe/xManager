 ...
 * @author scarface
 */
public class WarehouseStockTraceTableModel extends AbstractTableModel {
    ...
    String[] columnNames = {"Item Code", "Item Name", "Warehouse Name", "Date", "Total Requisition", "Opening Balance", "Stock Out", "Balance"};
    private Object[][] data;
    int ROW = 0;

    public WarehouseStockTraceTableModel(String shopName, String item, Date from, Date to) {
        ReportBL rb = new ReportBL();
        StocksOutBL stkbl = new StocksOutBL();
        entries = stkbl.getItemsTakenFromWarehouse(shopName, item, from, to);
        ...
        System.out.println("ROW2: " + stkbl.getItemsTakenFromWarehouse(shopName, item, from, to).size());
